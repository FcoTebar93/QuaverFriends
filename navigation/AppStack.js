  ...
  if (isSelected) {
      return (
          <View style={{ flex: 1, alignItems: 'center', borderWidth:0}}>
              ...
              >
                  <View style={{ flex: 1, backgroundColor: '#333333' }}></View>
                  <Svg
                      width={75}
                      height={61}
                      viewBox="0 0 75 61"
...
const MessageStack = ({navigation}) => (
  <Stack.Navigator
  >
    <Stack.Screen name="Mensajes" component={MessageScreen} />
    <Stack.Screen
      name="Chat"
      ...
      <Tab.Screen
        ...
        options={({route}) => ({
          ...
          tabBarIcon: ({ focused, size}) => (
            ...
            <Text style={{color:focused ? '#333333' : 'white',
    fontSize: 12,}}>
                                Home
                            </Text>
    ...
    fontSize: 12, textAlign:'center'}}>
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused, size}) => (
            <View>
            <Ionicons name="person-outline" color={focused ? '#333333' : 'white'} size={size} />
            <Text style={{color:focused ? '#333333' : 'white',
    fontSize: 12,}}>
                                Profile
                            </Text>
